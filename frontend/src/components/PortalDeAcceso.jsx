...
const PortalDeAcceso = () => {
    ...
    return (
        ...
        <Menubar.Root className="relative top-5 z-[1] flex h-0 ">
            <Menubar.Menu>
                <Menubar.Trigger className="py-5 px-7 border bg-sky-400  outline-none select-none font-medium leading-none rounded text-slate-900 text-[13px] flex items-center justify-between gap-[2px] data-[highlighted]:bg-violet4 data-[state=open]:bg-violet4">
                    Portal de Acceso
                </Menubar.Trigger>
                <Menubar.Portal>
                    <Menubar.Content
