        ...
        <div className="mt-4 flex flex-col bg-gray-100 rounded-lg p-4 shadow-sm">
            <div className="mt-4 flex flex-row space-x-2">
                <div className="flex-1">
                  ...
                  <input placeholder=" " className="w-full bg-slate-400 rounded-md border-gray-300 text-black px-2 py-1" id="nombre" type="text"/>
                </div>

                <div className="flex-1">
                  <label className="text-black" >Apellidos</label>
                  <input placeholder=" " className="w-full bg-slate-400 rounded-md border-gray-300 text-black px-2 py-1" id="apellido" type="text"/>
                </div>
            </div>
            ...
            <div className="mt-4 flex flex-row space-x-2">
                <div className="flex-1">
                 ...
                 <input placeholder=" " className="w-full bg-slate-400 rounded-md border-gray-300 text-black px-2 py-1" id="telefono" type="text"/>
                </div>

                <div className="flex-1">
                 <label className="text-black" >Fecha de Nacimiento</label>
                 <input placeholder=" " className="w-full bg-slate-400 rounded-md border-gray-300 text-black px-2 py-1" id="fechaNacimiento" type="date"/>
                </div>
            </div>
