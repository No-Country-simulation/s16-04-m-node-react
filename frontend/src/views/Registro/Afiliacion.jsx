        ...
        <div className="mt-4 flex flex-col bg-gray-100 rounded-lg p-4 shadow-sm">
            <div className="mt-4 flex flex-row space-x-2 ">
                <div className="flex-1">
                    ...
                    <select className="w-[96%] bg-slate-400 rounded-md border-gray-300 text-black px-2 py-1" id="nameOS">
                ...
                <div className="flex-1">
                  ...
                  <input placeholder=" " className="w-[89%] bg-slate-400 rounded-md border-gray-300 text-black px-2 py-1" id="numAfiliado" type="text"/>
                </div>
            ...
            <div className="mt-4 flex flex-row space-x-2">
                <div className="flex-1">
                  ...
                  <input placeholder=" " className="w-[88%] bg-slate-400 rounded-md border-gray-300 text-black px-2 py-1" id="fechaAfiliado" type="date"/>
                </div>
